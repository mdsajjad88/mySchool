    ...
    <ul class="navbar-nav sidebar sidebar-light myBar accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        <div class="sidebar-brand-icon">
          <img src="../all_image/logo.png" id="logo">
        </div>
        <div class="sidebar-brand-text mx-3">PASC, Rangpur</div>
      </a>
      ...
      <li class="nav-item">
        <a href="" class="nav-link"> Class Routine</a>
      </li>
      <li class="nav-item">
        <a href="" class="nav-link"> Result & Notice</a>
      </li>
      <li class="nav-item">

...
if(isset($_POST['logBTN'])){
	...
	if(empty($mail) || empty($pass)){
		...
		// if($count == 0){
		// 	$respons = "<div class='alert alert-danger'> This G-mail is not Found ID</div>";
		// }
		
		if($row['birthday']== $pass){
			if($row['designation']=='accountant'){
				...
				$respons = "<div class='alert alert-danger'> This G-mail is not Accountant ID</div>";
			}
		}
		else{
	...
	// else{
	// 	$respons = "<div class='alert alert-danger'> No Account Found in this G-mail</div>";
	// }
}
...
<body>
		<div class="container mt-5 bg-secondary maypaga">
			<div class="row">
				<div class="col-4"></div>

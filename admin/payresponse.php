...
if(isset($_POST['uid'])){
    ...
    while($row = $select->fetch(PDO::FETCH_ASSOC)){
        $output .= "
             ...
             <div class='col-8'>
               <p > <input type = 'number' class='form-control' id='amount' name='amount' placeholder='Enter Amount'> </p> <span id='amnt'></span>
             </div>
             <div class='col-4'>
        ...
        <div class='col-4 mt-2'>
          ...
          <div class='col-8 mt-2'>
            <p > <input type = 'number' class='form-control' id='account' name='account' placeholder='Enter Account No'> </p> 
          </div>
          <div class='col-4'>
             <b class='form-control bg-dark text-light'> Enter Password </b>  
          </div>
          <div class='col-8'>
            <p > <input type = 'password' class='form-control' name='pass' placeholder='Enter your Password'> </p> 
          </div>
